...
def prophet_predict(Municipality,Municipality_train,Municipality_test):
    ...
    #Saving figure
    plt.savefig("C:\\Users\\fuat.yahsi\\Desktop\\piworks\\Graphs\\USAGE VALUES FOR MUNICIPALTY {} by Prohpet.jpg".format(int(Municipality_test.municipality_id.mean())),dpi = 200)
...
def ARIMA_prediction(municipality,municipality_train,municipality_test):
    ...
    #Saving figure
    plt.savefig("C:\\Users\\fuat.yahsi\\Desktop\\piworks\\Graphs\\USAGE VALUES FOR MUNICIPALTY {} by ARIMA.jpg".format(int(municipality_test.municipality_id.mean())),dpi = 200)
...
def XGB_predictor(Municipality,train_data,test_data):
    '''Predicts usage values using XGBo model for given future dates then evaluates the results by visualizing '''
    #train data
    ...
    #Saving figure
    plt.savefig("C:\\Users\\fuat.yahsi\\Desktop\\piworks\\Graphs\\USAGE VALUES FOR MUNICIPALTY {} by XGB.jpg".format(int(Municipality.municipality_id.mean())),dpi = 200)
...
def RNN_predictor(Municipality,Municipality_train,Municipality_test):
    ...
    # Fitting the model
    history = model.fit(scaled_X_train,scaled_y_train,epochs=50,batch_size = 32,validation_split=0.01)
    ...
    #Saving figure
    plt.savefig("C:\\Users\\fuat.yahsi\\Desktop\\piworks\\Graphs\\USAGE VALUES FOR MUNICIPALTY {} by RNN.jpg".format(Municipality.municipality_id.max()),dpi = 200)
